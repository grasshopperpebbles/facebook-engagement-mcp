...
date: 2026-09-02
verified: "Steps 1-5 walked against a live Page, 2026-09-03. ads_read path partially documented 2026-09-07. business_management required for /me/accounts under Business Portfolio — verified in Graph API Explorer 2026-09-15. Explorer-first (non-developer) walkthrough updated 2026-09-15."
---

<!-- Generated by scripts/sync-docs.mjs from the broadkast content repo,
...
(that path uses git; non-developers do not). Python and Go ship as their own
packages — see [Pick your language](https://github.com/grasshopperpebbles/facebook-engagement-mcp#pick-your-language).
